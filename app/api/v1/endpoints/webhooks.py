...
async def handle_solidgate_webhook(
    ...
    print("=" * 80)
    print(
        f"request.headers.get(solidgate-event-type): {request.headers.get('solidgate-event-type')}"
    )
    print(
        f"request.headers.get(solidgate-event-id): {request.headers.get('solidgate-event-id')}"
    )
    print("=" * 80)
    print("=" * 80)
